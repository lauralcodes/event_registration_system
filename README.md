...
The project also includes a Flask REST API for managing events.
...
- Use HTTP status codes and JSON responses
...
- Add an endpoint to view registrations
- Add automated tests
...
The goal of this project is to gradually build a more complete backend application while developing practical skills in Python, OOP, databases, REST APIs, Flask, and software development practices.
